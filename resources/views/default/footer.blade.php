...
<script type="text/javascript">
    ...
    let allShown = true,
        all = document.querySelector('.index-page__section-pics__all'),
        picsTabs = document.querySelectorAll('.index-page__section-pics__inner');
    picsTabs.forEach(v => {
        v.style.opacity = 0;
    });
    const showTab = (tabId) => {
        ...
        document.querySelector(`${tabId}-about`).classList.add('active');
        shownTab = tabId;
        return false;
    }
    ...
    if (isMobile) {
        const tabs = document.querySelectorAll('.index-page__section-pics__row');
